...
.custom-carousel::before {
  left: 0;
  background: linear-gradient(to right, rgba(27, 27, 27, 0.3), transparent);
}
.custom-carousel::after {
  right: 0;
  background: linear-gradient(to left, rgba(27, 27, 27, 0.3), transparent);
}
...
.custom-vehicle-image {
  width: 100%;
  height: 60%; /* Aloca 60% da altura para a imagem */
  overflow: hidden;
  position: relative;
}
.custom-vehicle-image img {
  width: 100%;
  height: 100%;
  object-fit: cover;
  transition: transform 0.3s ease;
}
.custom-vehicle-card:hover .custom-vehicle-image img {
  transform: scale(1.05);
}
.custom-vehicle-info {
  flex: 1; /* Garante que a informação ocupe o espaço restante */
  padding: 1rem;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
.custom-vehicle-detail-item {
  display: flex;
  align-items: center;
  text-align: center;
  gap: 0.3rem;
}
.custom-vehicle-detail-item img {
  width: 24px;
  height: 24px;
}
.custom-price {
...
@media (max-width: 1280px) {
  ...
  .custom-vehicle-image {
    height: 55%; /* Ajusta proporcionalmente */
  }
}
@media (max-width: 1024px) {
  .custom-vehicle-card {
...
.tabs-carousel .splide__list {
  display: flex;
  gap: 1rem; /* Adiciona um espaço de 1rem entre os slides */
}
.tabs-carousel .splide__slide {
  flex: 0 0 calc((100% / 5) - 1rem); /* Divida o container pelo número de itens visíveis */
}
.splide_list_tab {
  flex: 0 0 auto; /* Garante que cada item do slide mantenha seu tamanho */
}
...
.vehicle-card {
  ...
  overflow: hidden;
  transition: transform 0.3s ease, box-shadow 0.3s ease;
  width: 100%; /* Alinha o tamanho ao container */
  max-width: 300px; /* Limite máximo para o tamanho do card */
...
.vehicle-image {
  width: 100%;
  height: 60%; /* Proporção consistente para a imagem */
  overflow: hidden;
}
...
.vehicle-info {
  ...
  justify-content: space-between;
  gap: 0.5rem;
  flex-grow: 1; /* Faz com que o conteúdo se ajuste ao restante do espaço */
}
